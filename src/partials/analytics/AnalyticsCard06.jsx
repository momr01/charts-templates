...
import { topPages } from "../../codes/barCharts";
...
function AnalyticsCard06() {
  ...
  return (
    <div
      className={`flex flex-col col-span-full sm:col-span-6 xl:col-span-8 bg-white shadow-lg rounded-sm border border-slate-200 ${
        !showCode && "h-[29rem]"
      }`}
    >
