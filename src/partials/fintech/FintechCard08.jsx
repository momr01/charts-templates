...
import { lineChart7 } from "../../codes/lineCharts";
...
function FintechCard08() {
  ...
  return (
    <div
      className={`flex flex-col col-span-full sm:col-span-12 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200 ${
        !showCode && "xl:h-[33rem]"
      }`}
    >
